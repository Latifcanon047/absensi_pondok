...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const [semuaAsrama, semuaMakan] = await Promise.all([
    ...
    // Summary keseluruhan
    const semua = [...semuaAsrama, ...semuaMakan];
