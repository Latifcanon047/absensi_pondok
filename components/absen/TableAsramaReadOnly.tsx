...
type TabelAsramaReadOnlyProps = {
  santriList: Santri[];
  asramaStates: Record<string, StatusAbsen | null>;
};

export default function TabelAsramaReadOnly({
  santriList,
  asramaStates,
}: TabelAsramaReadOnlyProps) {
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 mb-6 overflow-hidden hover:shadow-md transition-all duration-300">
      ...
      <div className="px-6 py-4 border-b border-gray-100 bg-linear-to-r from-gray-50 to-white">
        <div>
          <h2 className="font-semibold text-gray-800">Absen Asrama</h2>
